...
public class Lawyers extends AppCompatActivity {
    ...
    private TextInputEditText practiceNumberEditText;
    private TextInputEditText workPlaceEditText;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        practiceNumberEditText   = findViewById(R.id.practice_number);
        workPlaceEditText = findViewById(R.id.work_place);
    ...
    private void submitForm() {
        ...
        String practiceNumber = practiceNumberEditText.getText().toString().trim();
        ...
        RequestBody rbPractice   = textPart(practiceNumber);
        RequestBody rbWorkPlace  = textPart(workPlace);
        ...
        if (token == null) {
            Toast.makeText(Lawyers.this, "No token found", Toast.LENGTH_SHORT).show();
        }
        apiService = RetrofitClient.getRetrofitInstance().create(ApiService.class);
        apiService.registerLawyer(
                "Bearer " + token,
                rbFirst, rbSecond, rbPhone, rbNationalId,
                rbPractice, rbWorkPlace, rbPhysical, rbPostal,
                photoPart
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (response.isSuccessful() ) {
                    ...
                    Toast.makeText(Lawyers.this, "Registration successfull",Toast.LENGTH_LONG).show();



                    Intent intent = new Intent(Lawyers.this, HomePage.class); // Replace HomepageActivity.class with your actual homepage Activity
